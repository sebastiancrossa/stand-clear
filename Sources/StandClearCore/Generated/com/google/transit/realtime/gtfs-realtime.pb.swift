...
struct TransitRealtime_Alert: SwiftProtobuf.ExtensibleMessage, Sendable {
  ...
  /// If multiple ranges are given, the alert will be shown during all of them.
  var communicationPeriod: [TransitRealtime_TimeRange] = []
  ...
  var impactPeriod: [TransitRealtime_TimeRange] = []
...
extension TransitRealtime_Alert: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}active_period\0\u{3}communication_period\0\u{3}impact_period\0\u{4}\u{2}informed_entity\0\u{1}cause\0\u{1}effect\0\u{1}url\0\u{4}\u{2}header_text\0\u{3}description_text\0\u{3}tts_header_text\0\u{3}tts_description_text\0\u{3}severity_level\0\u{1}image\0\u{3}image_alternative_text\0\u{3}cause_detail\0\u{3}effect_detail\0")

  public var isInitialized: Bool {
    if !_protobuf_extensionFieldValues.isInitialized {return false}
    if !SwiftProtobuf.Internal.areAllInitialized(self.activePeriod) {return false}
    if !SwiftProtobuf.Internal.areAllInitialized(self.communicationPeriod) {return false}
    if !SwiftProtobuf.Internal.areAllInitialized(self.impactPeriod) {return false}
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.communicationPeriod) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.impactPeriod) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.communicationPeriod.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.communicationPeriod, fieldNumber: 2)
    }
    if !self.impactPeriod.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.impactPeriod, fieldNumber: 3)
    }
  ...
  static func ==(lhs: TransitRealtime_Alert, rhs: TransitRealtime_Alert) -> Bool {
    ...
    if lhs.communicationPeriod != rhs.communicationPeriod {return false}
    if lhs.impactPeriod != rhs.impactPeriod {return false}
